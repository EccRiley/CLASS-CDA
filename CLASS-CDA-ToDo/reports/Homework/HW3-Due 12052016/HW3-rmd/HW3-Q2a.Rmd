...
```{r dat2a, fig.cap="Bivariate correlations (upper), implied bivariate loess model curves (lower), and individual variable distributions (diagonal)", fig.fullwidth=TRUE}
